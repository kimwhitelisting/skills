...
- **문서 요약**: 이 문서는 [anthropics/skills](https://github.com/anthropics/skills) 기반이며, **Claude가 어떤
             구조로 스킬을 실행하는지 이해하고 커스텀 스킬 작성 기준을 확보하는 것**이 목적입니다.

- **핵심 섹션**: 이 가이드에서 얻는 것, Claude 스킬 동작 방식, 커스텀 스킬 작성 체크리스트, 빠른 이동: 공개 스킬, 빠른 이동: 예제 스킬, 실제 사용법
