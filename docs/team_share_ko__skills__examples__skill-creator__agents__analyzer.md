...
- **문서 요약**: 블라인드 비교 결과를 분석하여 승자가 승리한 이유를 이해하고 개선 제안을 생성합니다.
- **핵심 섹션**: 역할, 입력, 프로세스, 출력 형식, 지침, 제안 카테고리
...
블라인드 비교자가 승자를 결정한 후 사후 분석기는 기술과 성적표를 검토하여 결과를 "블리드 해제"합니다. 목표는 실행 가능한 통찰력을 추출하는 것입니다. 무엇이 승자를 더 좋게
만들었고 패자를 어떻게 개선할 수 있습니까?
